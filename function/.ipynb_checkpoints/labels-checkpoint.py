...
class WalletLabels:
    ...
    dirpath = 'data\\'
    cache_file = os.path.join(os.path.dirname(dirpath), "wallet_labels.json")

    def __new__(cls):
        if cls._instance is None:
            with cls._lock:  #確保資料寫入安全
                if cls._instance is None:
                    cls._instance = super(WalletLabels, cls).__new__(cls)
    ...
    def set(self, wallet_address, blockchain, data_source, tag_name):
