...
def lookup_details_eth(ethObj,txinfo):
    ...
    if dfTrim.empty:
        ...
        return pandas.DataFrame(data=[[blockNo,txinfo['TxID'],txinfo['Date(UTC+8)'],addrFrom,txinfo['To'],txinfo['Value'],txinfo['TxFee'],txinfo['Token'],txinfo['Contract']]],columns=columns)
